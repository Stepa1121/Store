...
const SearchBar = ({isSearchOpen, toggleSearch, isMobile }) => {
  ...
  */}
  ...
  return (
    <animated.div className='fullscreen-element grid grid-cols-12 grid-rows-12 p-5' style={mobileProps}>
      <div className='flex justify-center items-center row-start-1 col-start-12'>
      ...
      <div className='relative col-span-11 col-start-2 row-start-2 flex items-center'>
        {/* Полоска снизу */}
